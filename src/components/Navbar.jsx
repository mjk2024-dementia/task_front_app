...
import { navMenus } from '../utlis/data';
...
const Navbar = ({menuIdx}) => {
  ...
  return (
    <nav className="navi bg-[#212121] w-1/5 h-full rounded-sm border border-gray-500 py-10 px-4 flex flex-col justify-between item-center">
      <div className="login-wrapper flex w-full items-center justify-center gap-8">
        ...
        {isAuth ? (
          <div className='w-4/5'>
            <button 
             ...
             className='font-customFontKR flex justify-center item-center gap-2 bg-gray-300 text-gray-900 py-2 px-4 rounded-md w-full'
             >
