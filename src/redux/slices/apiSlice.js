...
const apiSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchDeleteItemData.fulfilled, handleFullfilled('deleteItemData'))
      .addCase(fetchDeleteItemData.rejected, handleRejected)
      .addCase(fetchUpdateCompletedData.fulfilled, handleFullfilled('updateCompletedData'))
